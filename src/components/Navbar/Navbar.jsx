    ...
    <div className="shadow-md bg-white dark:bg-gray-900 dark:text-white duration-200">
        <div className="container py-3 sm:py-0">
            <div className="flex justify-between items-center">
                <div>
                    <a href="#" className="flex items-center gap-6  text-2xl sm:text-3xl font-bold" >
                        <img src={logo} alt="logo" className="w-10"/> meet & Eat
                    </a>
                </div>
                <div className="flex items-center gap-4">
                    ...
                    <FaCartShopping className="text-xl text-white drop-shadow-sm cursor-pointer"/></button>
                </div>
            </div>
        </div>
    </div>
