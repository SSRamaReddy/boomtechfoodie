            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                <p className="text-sm text-gray-500 tracking-wide leading-5">
                  Explore Our Services With High Hungryness
                  <br />
                  <br />
                  A delicious dish crafted with flavorful rice and spices, prepared freshly to tantalize your taste buds. Give it a try today for an unforgettable experience!
                </p>
